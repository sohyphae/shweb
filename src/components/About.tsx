      ...
      <div className="about-container">
        ...
        <div className="about-text">
          ...
          <p className="body-text text-dark">
            Classical pianist turned electronic music enthusiast, Sophie uses shimmering synths and soaring vocals to weave an impressionistic story of how connection with nature, embracing sensitivity, and finding kindred good souls on the dancefloor will win over disconnection and accelerationism.
          </p>
          <p className="body-text text-dark">
